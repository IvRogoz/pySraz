Create one horizontal sprite strip for the 2D game character `medieval-footman` in animation `attack`.
...
Animation action: short sword attack loop in isometric RPG view.
